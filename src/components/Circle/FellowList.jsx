  ...
  render() {
    ...
    return (
      <Segment style={{ marginBottom: "20px" }}>
        ...
        { (this.props.circle.isAdmin || this.props.circle.isCreator) && <Button as={Link} to={`/circle/${this.props.circle.handle}/add-admin`} content="Add Admin" icon='add' labelPosition='left' />}
        { (this.props.circle.isAdmin || this.props.circle.isCreator) && <Button style={{ marginBottom: "20px" }} as={Link} to={`/circle/${this.props.circle.handle}/add-fellow`} content="Add Fellow" icon='add' labelPosition='right' />}
        <div style={{ textAlign: "left" }}>
          <Item.Group divided unstackable>
            {this.props.circle.fellows.map((user, i) => (
              <Item key={`item${i}`}>
                ...
                <Item.Content>
                  ...
                  { (this.props.circle.isAdmin || this.props.circle.isCreator) && <Button circular onClick={this.confirmRemove(user)} floated="right" icon="remove user" /> }
