...
const MySidebar = props => (
  <Sidebar style={{ height: "121%" }} className="my-sidebar" as={Menu} animation='uncover' direction='left' width='wide' borderless visible={ props.visible } icon='labeled' vertical >
    ...
    <Menu.Item style={ menuItemStyle } onClick={ props.toggleSidebar } as={ NavLink } to="/polls" name='polls'>
      <Icon name='inbox' />
      Polls
    </Menu.Item>
    <Menu.Item style={ menuItemStyle } onClick={ props.toggleSidebar } as={ NavLink } to="/circles" name='circles'>
      <Icon name='users' />
      Cirlces
    </Menu.Item>
    <Menu.Item style={ menuItemStyle } onClick={ props.toggleSidebar } as={ NavLink } to={ props.currentUser.username ? `@${props.currentUser.username}` : "login" } name='profile'>
      <Icon name='user' />
      Profile
    </Menu.Item>
    <Menu.Item style={ menuItemStyle } onClick={ props.toggleSidebar } as={ NavLink } to="/explore" name='profile'>
